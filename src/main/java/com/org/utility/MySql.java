...
import java.util.Properties;
    ...
    public class MySql {
        ...
        public static ArrayList query_Post_connection_To_MySQL_Via_JumpServer (String dbQuery , String serviceEndPoint ){
            ...
            if (serviceEndPoint.matches(".*?PROD.*?")) {

                //ssh details
                SSH_USER = "??";SSH_PASSWORD = "pa55word";SSH_HOSTNAME = "att-stagegw01.org.com";SSH_PORT = 22;
                //db details
                MY_SQL_HOSTNAME = "att-devaddb01";
                DATABASE = "abm_db";LOCALPORT = 3366;REMOTEPORT = 3306;DB_USERNAME = "abmuser";DB_PASSWORD = "abmuser%$45";
            }
            ...
            if (serviceEndPoint.matches(".*?STAGE.*?")) {
                ...
                //ssh details
                SSH_USER = "akulkarni";SSH_PASSWORD = "Mswinse123";SSH_HOSTNAME = "att-stagegw01.org.com";SSH_PORT = 22;
                //db details
                MY_SQL_HOSTNAME = "uswvpc-stagedb01.cvvsbv3ckumk.us-west-1.rds.amazonaws.com";
                DATABASE = "mapapi";LOCALPORT = 3366;REMOTEPORT = 3306;DB_USERNAME = "org";DB_PASSWORD = "org10";
            }
