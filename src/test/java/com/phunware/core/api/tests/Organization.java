...
public class Organization {
    ...
    public static String organizationID="132";
    public static String capturedNewOrganizationID;
    ...
    public void verify_Get_Organization_Details(){
        ...
        //Request Details
        String requestURL= CoreAPI_Constants.SERVICE_END_POINT+ CoreAPI_Constants.ORGANIZATION_END_POINT+organizationID;
    ...
    public void verify_Get_Organization_Details_InvalidOrgID(){
        ...
        //Request Details
        String requestURL= CoreAPI_Constants.SERVICE_END_POINT+ CoreAPI_Constants.ORGANIZATION_END_POINT+"000";
    ...
    public void verify_Get_Collection_Of_Organizations(){
        ...
        //Request Details
        String requestURL= CoreAPI_Constants.SERVICE_END_POINT+ CoreAPI_Constants.ORGANIZATIONS_COLLECTION_END_POINT;
        ...
        //Extracting response after status code validation
        Response response = given().header("Content-Type", "application/json")
                .header("Authorization",CoreAPI_Constants.AUTHORIZATION).queryParam("{\"name\":\"QA\"}")
                .get(requestURL).then().statusCode(200).extract().response();
        ...
        for (int i =0 ; i<=response.then().extract().jsonPath().getList("data").size()-1;i++){
            Assert.assertTrue(response.then().extract().path("data.name["+i+"]").toString().matches(".*qa.*|.*QA.*"));
        }
    }
    ...
    public void verify_Get_Collection_Of_Organizations_NameWithEmptyString(){
        ...
        //Extracting response after status code validation
        Response response = given().header("Content-Type", "application/json")
                .header("Authorization",CoreAPI_Constants.AUTHORIZATION).queryParam("{\"name\":\"\"}")
                .get(requestURL).then().statusCode(200).extract().response();
    ...
    public void verify_Get_Collection_Of_Organizations_Pagination(){
        ...
        //Extracting response after status code validation
        Response response = given().header("Content-Type", "application/json")
                .header("Authorization",CoreAPI_Constants.AUTHORIZATION).queryParam("{\"name\":\"qa\",\"offset\":\"1\",\"limit\":\"15\",\"org_id\":\"\"}")
                .get(requestURL).then().statusCode(200).extract().response();
    ...
    public void verify_Get_Collection_Of_Organizations_Pagination_EmptyName(){
        ...
        //Extracting response after status code validation
        Response response = given().header("Content-Type", "application/json")
                .header("Authorization",CoreAPI_Constants.AUTHORIZATION).queryParam("{\"name\":\"\",\"offset\":\"0\",\"limit\":\"15\",\"org_id\":\"\"}")
                .get(requestURL).then().statusCode(200).extract().response();
    ...
    public void verify_Post_Create_New_Organization(){
        ...
        //Extracting response after status code validation
        Response response = given().header("Content-Type", "application/json")
                .header("Authorization",CoreAPI_Constants.AUTHORIZATION).request().body(requestBody)
        ...
        capturedNewOrganizationID=response.then().extract().path("data.id").toString();
        log.info("Captured new Organization ID:"+capturedNewOrganizationID);
    ...
    public void verify_Put_Update_Organization(){
        ...
        //Request Details
        String requestURL= CoreAPI_Constants.SERVICE_END_POINT+ CoreAPI_Constants.ORGANIZATION_END_POINT+capturedNewOrganizationID;
        String requestBody = "{\"data\":{\"name\": \""+dynamicValue+"updated"+"\",\"services\": [\"analytics\",\"alerts\",\"content\",\"messaging\"]}}";
        ...
        //JSON response Pay load validations
        response.then().body("data.id",is(Integer.parseInt(capturedNewOrganizationID)));
    ...
    public void verify_Put_Update_Organization_EmptyName_InRequestBody(){
        ...
        //Request Details
        String requestURL= CoreAPI_Constants.SERVICE_END_POINT+ CoreAPI_Constants.ORGANIZATION_END_POINT+capturedNewOrganizationID;
        String requestBody = "{\"data\":{\"name\": \"\",\"services\": [\"analytics\",\"alerts\",\"content\",\"messaging\"]}}";
        ...
        Response response = given().header("Content-Type", "application/json")
                .header("Authorization",CoreAPI_Constants.AUTHORIZATION).request().body(requestBody)
                .put(requestURL).then().statusCode(400).extract().response();
    ...
    public void verify_Put_Update_Organization_EmptyServices_InRequestBody(){
        ...
        //Request Details
        String requestURL= CoreAPI_Constants.SERVICE_END_POINT+ CoreAPI_Constants.ORGANIZATION_END_POINT+capturedNewOrganizationID;
        String requestBody = "{\"data\":{\"name\": \""+dynamicValue+"updated"+"\",\"services\":[\"\"]}}";
    ...
    public void verify_Put_Update_Organization_InvalidOrganization(){
        ...
        //Request Details
        String requestURL= CoreAPI_Constants.SERVICE_END_POINT+ CoreAPI_Constants.ORGANIZATION_END_POINT+"!@a3";
        String requestBody = "{\"data\":{\"name\": \""+dynamicValue+"update"+"\",\"services\": [\"analytics\",\"alerts\",\"content\",\"messaging\"]}}";
