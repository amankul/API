...
public class DeviceAPI {
  ...
  public static String deviceId = HelperMethods.getUUIDAsString();
  public static String deviceRegKey = "d6BZSAdhNd8:APA91bHpVrhxUjCOHm-Tzf6HOZjtpsSUn3vgaxgMNiCdv7FjUds-OiyhjCKSFKMgHSAVNcwM5Eld8ZZz0QQzrzTRbjR7IdvzNcmiJeWu8uEi5Qr9oIPtL07vWFGLIAu2-X_FjQafXRHM_" + deviceId ;
  static Logger log;
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId","postDeviceRegistrationBodyPath"})
  @Test
  public void Verify_Device_Registration(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String postDeviceRegistrationBodyPath )throws IOException{
    //Request Details
    ...
    response.then().body(("geoFences.plus.flatten().any { it.containsKey('locationCode')}"), is(true));
    response.then().body(("geoFences.plus.flatten().any { it.containsKey('id')}"), is(true));
    response.then().body(("geoFences.plus.flatten().any { it.containsKey('validEventTypes')}"), is(true));
    response.then().body(("geoFences.plus.flatten().any { it.containsKey('geoShape')}"), is(true));
    response.then().body(("geoFences.plus.flatten().any { it.containsKey('allowsCheckin')}"), is(true));
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId","postDownloadGeofenceBodyPath"})
  @Test
  public void Verify_Download_Geofence(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String postDownloadGeofenceBodyPath )throws IOException{
    //Request Details
    String requestURL = serviceEndPoint + MeAPI_Constants.DEVICE_API_EVENTS_END_POINT;
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId","postGeofenceEntryBodyPath"})
  @Test
  public void Verify_Geofence_Entry(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String postGeofenceEntryBodyPath )throws IOException{
    //Request Details
    String requestURL = serviceEndPoint + MeAPI_Constants.DEVICE_API_EVENTS_END_POINT;
  ...
  @Test
  public void Verify_Get_Attribute_Metadata(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId )throws IOException{
    //Request Details
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId" , "postDeviceAttributesBodyPath", "deviceAttributeName", "deviceAttributeValue"})
  @Test
  public void Verify_Create_Device_Attributes(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String postDeviceAttributesBodyPath, String deviceAttributeName, String deviceAttributeValue )throws IOException{
    //Request Details
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId" , "deviceAttributeName", "deviceAttributeValue"})
  @Test
  public void Verify_Get_Device_Attributes(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String deviceAttributeName, String deviceAttributeValue )throws IOException{
    //Request Details
    String requestURL = serviceEndPoint + MeAPI_Constants.DEVICE_ATTRIBUTE_API_END_POINT;
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId","postGeofenceExitBodyPath"})
  @Test
  public void Verify_Geofence_Exit(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String postGeofenceExitBodyPath )throws IOException{
    //Request Details
    String requestURL = serviceEndPoint + MeAPI_Constants.DEVICE_API_EVENTS_END_POINT;
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId","postStaticIdSetBodyPath"})
  @Test
  public void Verify_Set_StaticId(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String postStaticIdSetBodyPath )throws IOException{
    //Request Details
    String requestURL = serviceEndPoint + MeAPI_Constants.DEVICE_API_EVENTS_END_POINT;
  ...
  @Parameters({ "clientId_android_access_key", "clientId_android_signature_key","orgId", "clientId","postDeviceRegistrationBodyPath"})
  @Test
  public void Verify_Device_Unregistration(String clientId_android_access_key, String clientId_android_signature_key, String orgId, String clientId, String postDeviceRegistrationBodyPath )throws IOException{
    //Request Details
    String requestURL = serviceEndPoint + MeAPI_Constants.DEVICE_API_EVENTS_END_POINT;
